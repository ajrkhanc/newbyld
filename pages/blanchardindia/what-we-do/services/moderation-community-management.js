                    ...
                    <div className='row align-items-center'>
                        <div className='col-sm-6 pa0000'>
                            <div className='prr-90'>
                                <img src="/kbassets/img/kbnew/Engage-and-Motivate.jpg" alt="Images" />
                            </div>
                        </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/kbassets/img/kbnew/Human-powered-connection.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='row'>
                        ...
                        <div className="col-sm-4">
                            <div className="AProfessional pll-20 prr-20">
                                <img className="" src="/kbassets/img/kbnew/icon/Fostering-Inclusion.svg" alt="Images" />
                        ...
                        <div className="col-sm-4">
                            <div className="AProfessional pll-20 prr-20">
                                <img className="" src="/kbassets/img/kbnew/icon/Keep-Learners-on-Track.svg" alt="Images" />
                        ...
                        <div className="col-sm-4">
                            <div className="AProfessional pll-20 prr-20">
                                <img className="" src="/kbassets/img/kbnew/icon/Peer-to-Peer-Engagement.svg" alt="Images" />
            ...
            <section className="ptt-60 pbb-60 ExploreCustom colortheme2bg">
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/kbassets/img/kbnew/Dont-leave-your-leadership-development.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
