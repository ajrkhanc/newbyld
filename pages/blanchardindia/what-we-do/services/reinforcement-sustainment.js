        ...
        <>
                    ...
                    <div className="row">
                        <div className="col-sm-12 ptt-25 pbb-50">
                            <ul>
                                ...
                                <li><a><span>REINFORCEMENT & SUSTAINMENT</span></a></li>
                            </ul>
                        </div>
                        <div className="col-sm-12">
                            <div className="innerbedkms text-center">
                                <h1>Learning Reinforcement & Sustainment</h1>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/kbassets/img/kbnew/Learning-doesn’t-stop.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row align-items-center">
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder prr-90">
                                <img className="" src="/kbassets/img/kbnew/Learning-designed-to.jpg" alt="Images" />
                            </div>
                        </div>
                        <div className="col-sm-6">
            ...
            <section className="ptt-60 pbb-60">
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/kbassets/img/kbnew/Post-learning-session-tools.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="container pbb-50">
                        <div className='row'>
                            ...
                            <div className='col-sm-4'>
                                <div className='reinner inncc'>
                                    <a className="minihc" href=''>
                                        <img src="/kbassets/img/kbnew/icon/Curated-Content.svg" alt="Images" />
                            ...
                            <div className='col-sm-4'>
                                <div className='reinner inncc'>
                                    <a className="minihc" href=''>
                                        <img src="/kbassets/img/kbnew/icon/Microlearning.svg" alt="Images" />
                                        <h3>Microlearning</h3>
                                        <p>
                                        Learners can quickly access support in a critical area whenever needed with our bite-size microlearning kbassets -- videos, activities, and downloadable tools.
                                        </p>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className='col-sm-4'>
                                <div className='reinner inncc'>
                                    <a className="minihc" href=''>
                                        <img src="/kbassets/img/kbnew/icon/Technology.svg" alt="Images" />
                                        <h3>Technology</h3>
                                        <p>
            ...
            <section className="ptt-60 pbb-60 ExploreCustom colortheme2bg">
                <div className="container">
                    ...
                    <div className="col-sm-6">
                            <div className="mimg100 imgborder prr-90">
                                <img className="" src="/kbassets/img/kbnew/Invest-in-training-that.jpg" alt="Images" />
                            </div>
                        </div>
                        <div className="col-sm-6">
                            ...
                            <a href='/blanchardindia/our-content' className='kbbtn kbbtn--orange mtt-20'>Learn More About Our Programs</a>
                        </div>                        
                    </div>
                </div>
            </section>
