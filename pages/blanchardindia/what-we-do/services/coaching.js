                    ...
                    <div className="row">
                        <div className="col-sm-12 ptt-25 pbb-50">
                            <ul>
                                ...
                                <li className="brdlifirst"><a href="#">SERVICES</a></li>                                
                                <li><a><span> COACHING</span></a></li>
                            </ul>
                        </div>                
                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="mimg100 imgborder prr-90">
                                <img src="/kbassets/img/kbnew/Transform-Your-People-With-Coaching.jpg" alt="Images" />
                            </div>
                        </div>
                        <div className='col-sm-6'>
                            <div>
            ...
            <div className='container-fluid ptt-90 pbb-60 borderedus0'>
               ...
               <div className="col-sm-1"></div>                
                  <div className='col-sm-10 pbb-70'>
                     ...
                     <h2 className="sectionh">The Power Of Blanchard Corporate Coaching</h2>
                     <p>
                  ...
                  <div className="col-sm-3">
                    ...
                    <img className="" src="/kbassets/img/kbnew/icon/Speedy-Skill-Adoption.svg" alt="Images" />
                    <h3>Speedy Skill Adoption</h3>
                    <p>Coaches will help your leaders prioritize and master new skills at their own pace.</p>
                    </div>
                  </div>

                  <div className="col-sm-3">
                    <div className="AProfessional pll-20 prr-20">
                    <img className="" src="/kbassets/img/kbnew/icon/Build-Leadership-Bench.svg" alt="Images" />
                    <h3>Strengthen the leadership bench</h3>
                    <p>
                  ...
                  <div className="col-sm-3">
                    <div className="AProfessional pll-20 prr-20">
                    <img className="" src="/kbassets/img/kbnew/icon/Improve-Productivity_1.svg" alt="Images" />
                    <h3>Enhance productivity</h3>
                    <p>Coaches will help people achieve their personal development goals by focusing on what matters most.</p>
                    </div>
                  </div>

                  <div className="col-sm-3">
                    <div className="AProfessional pll-20 prr-20">
                    <img className="" src="/kbassets/img/kbnew/icon/Increase-Learning-Retention.svg" alt="Images" />
                    <h3>Improve Learning Retention and ROI</h3>
                    <p>
         ...
         <section className="ptt-60 pbb-60">
                <div className="container">
                    <div className="row align-items-center">
                        <div className='col-sm-6'>
                        <div className="mimg100 imgborder prr-90">
                                <img src="/kbassets/img/kbnew/Coaching-for-Executives-and-Senior-Leaders.jpg" alt="Images" />
                            </div>
                        </div>
                        <div className='col-sm-6'>
                            <div>
                ...
                <div className="container">
                    <div className="row align-items-center">                        
                        ...
                        <div className="mimg100 imgborder pll-90">
                                <img src="/kbassets/img/kbnew/Team-Coaching.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="ptt-60 pbb-60">
                <div className="container">
                    ...
                    <div className='col-sm-6'>
                        <div className="mimg100 imgborder prr-90">
                                <img src="/kbassets/img/kbnew/Coaching-to-Integrate-Learning-for-Individuals.jpg" alt="Images" />
                            </div>
                        </div>
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                ...
                                <img src="/kbassets/img/kbnew/icon/left-quote.png" alt="Images" />
                                    <h5>
                                    Blanchard coaches made this a richer experience for leaders by helping them to set goals prior to training and to create an action plan to drive their learning.
                                    </h5>
                                    <h4>LAURA ASIALA - PYXERA GLOBAL</h4>
                                </div>
                            </div>
                        </div>
                    </div>
