...
export default function ThanYouLP() {
    return (
        ...
        <link rel="canonical" href="https://byldgroup.com/blanchardindia/what-we-do/leadership-development/digital-virtual-learning-experiences" />
                ...
                <div className="container pbb-50">
                    <div className='row'>
                        ...
                        <div className='col-sm-4'>
                            <div className='reinner inncc'>
                                <a className="minihc" href=''>
                                    <img src="/kbassets/img/kbnew/icon/proven-content-that-works.svg" alt="Images" />
                        ...
                        <div className='col-sm-4'>
                            <div className='reinner inncc'>
                                <a className="minihc" href=''>
                                    <img src="/kbassets/img/kbnew/icon/human-connection.svg" alt="Images" />
                        ...
                        <div className='col-sm-4'>
                            <div className='reinner inncc'>
                                <a className="minihc" href=''>
                                    <img src="/kbassets/img/kbnew/icon/designed-for-the-learner.svg" alt="Images" />
                    ...
                    <div className='row align-items-center'>
                        <div className='col-sm-6 pa0000'>
                            <div className='prr-90'>
                                <img src="/kbassets/img/kbnew/online-programs-to-fit.jpg" alt="Images" />
                            </div>
                        </div>
                        <div className='col-sm-6'>
                            <div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6 pa0000">
                            <div className="mimg100 pll-90">
                                <img className="" src="/kbassets/img/kbnew/collaborative-online-experiences-to.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="ptt-60 pbb-60 ExploreCustom">
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/kbassets/img/kbnew/seamless-integration-with.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
