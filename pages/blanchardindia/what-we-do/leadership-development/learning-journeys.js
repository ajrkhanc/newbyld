        ...
        <>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/kbassets/img/kbnew/Giving-context-for-a-more.jpg" alt="Images" />
                            </div>
                        </div>                       
                    </div>
                </div>
            ...
            <div className='container-fluid ptt-90 pbb-60 borderedus0'>
               <div className='row'>                 
                  ...
                  <div className="col-sm-4">
                    <div className="AProfessional pll-50 prr-50">
                    <img className="" src="/kbassets/img/kbnew/icon/Tailored-to-Your-Needs.svg" alt="Images" />
         ...
         <section className="Supportinglearning ptt-80 pbb-60">
                <div className="container-fluid">
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                        <div className="mimg100 imgborder pll-90">
                                <img className="" src="/kbassets/img/kbnew/Designed-intentionally-to-meet.jpg" alt="Images" />
                            </div>
                        </div>                       
                    </div>
                </div>
            ...
            <section className="ptt-60 pbb-60 ExploreCustom colortheme2bg">
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/kbassets/img/kbnew/Enhance-your-talent-strategy.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
