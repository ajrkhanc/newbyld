                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/kbassets/img/kbnew/Bringing-human-powered-learning.jpg" alt="Images" />
                            </div>
                        </div>                       
                    </div>
                </div>
            ...
            <div className='container-fluid ptt-90 pbb-60 borderedus0'>
               <div className='row align-items-center'>                 
                  ...
                  <div className="col-sm-4">
                    ...
                    <img className="" src="/kbassets/img/kbnew/icon/turnkey-solution.svg" alt="Images" />
                    <h3>Start Today</h3>
                  ...
                  <div className="col-sm-4">
                    <div className="AProfessional pll-50 prr-50">
                    <img className="" src="/kbassets/img/kbnew/icon/proven-content-that-works.svg" alt="Images" />
                  ...
                  <div className="col-sm-4">
                    <div className="AProfessional pll-50 prr-50">
                    <img className="" src="/kbassets/img/kbnew/icon/Measurable-success.svg" alt="Images" />
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 pll-90">
                                <img className="" src="/kbassets/img/kbnew/Join-us.jpg" alt="Images" />
                            </div>
                        </div>                       
                    </div>
                </div>
            ...
            <section className="ptt-60 pbb-60 ExploreCustom colortheme2bg">
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/kbassets/img/kbnew/Power-your-leaders-for-good.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
