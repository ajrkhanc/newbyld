                    ...
                    <div className="row">
                        <div className="col-sm-12 ptt-25 pbb-50">
                            <ul>
                                ...
                                <li><a><span>CUSTOMIZED LEARNING EXPERIENCES</span></a></li>
                            </ul>
                        </div>                
                            <div className="col-sm-12">
                                <div className="innerbedkms text-center">
                                    <h1>Customized Learning Experiences</h1>                                    
                                </div>
                            </div>
                        </div>
                    </div>              
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/kbassets/img/kbnew/Tailor-content-and-delivery.jpg" alt="Images" />
                            </div>
                        </div>                       
                    </div>
                </div>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-sm-12 text-center">
                        <h2>How We Tailor and Customize</h2>
                    </div>
                    ...
                    <div className="col-sm-4">
                        <div className="howinner">
                            ...
                            <div className="howtext">
                                <h4>Persona Exploration</h4>
                                <p>Understand who you are looking to engage</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-4">
                        <div className="howinner">
                            ...
                            <div className="howtext">
                                ...
                                <p>Ensure strong sponsorship, integration, reinforcement, and measurement</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-4">
                        <div className="howinner">
                            ...
                            <div className="howtext">
                                ...
                                <p>Develop new or integrate your existing content</p>
                            </div>
                        </div>
                    </div>
         ...
         <section className="Supportinglearning ptt-80 pbb-60">
                <div className="container-fluid">
                    ...
                    <div className="col-sm-6">
                        <div className="mimg100 imgborder prr-90">
                                <img className="" src="/kbassets/img/kbnew/Our-Solutions-Architecture-Center-of-Excellence.jpg" alt="Images" />
                            </div>
                        </div>
            ...
            <section className="ptt-60 pbb-60 ExploreCustom colortheme2bg">
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/kbassets/img/kbnew/Custom-Design-Guiding-Principles.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="Supportinglearning ptt-80 pbb-60">
                <div className="container-fluid">
                    ...
                    <div className="col-sm-6">
                        <div className="mimg100 imgborder prr-90">
                                <img className="" src="/kbassets/img/kbnew/Let’s-Discuss-Your-Online-Leadership-Development-Needs.jpg" alt="Images" />
                            </div>
                        </div>
                        <div className="col-sm-6 pll-30">
