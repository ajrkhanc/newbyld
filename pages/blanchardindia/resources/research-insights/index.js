                            ...
                            <div className="what-did-left-content">
                                ...
                                <div className="col-sm-4">
                                        <div className="choose-card">
                                            <img src="/kbassets/img/kbnew/blog1.jpg" alt="Images" />
                                            <h3>Transformational Leadership: Inspiring Change and Driving Innovation</h3>
                                    ...
                                    <div className="col-sm-4">
                                        <div className="choose-card">
                                            ...
                                            <h3>Are You a Directive or Supportive <br></br>Leader?</h3>
                                            <div className='row text-center eventsbottomarea2'>
                                                <div className='col-sm-12'>
                                    ...
                                    <div className="col-sm-4">
                                        <div className="choose-card">
                                            ...
                                            <h3>Coaching Skills: The Missing Link <br></br>for Leaders</h3>
                                            <div className='row text-center eventsbottomarea2'>
                                                <div className='col-sm-12'>
                                    ...
                                    <div className="col-sm-4">
                                        <div className="choose-card">
                                            <img src="/kbassets/img/kbnew/blog2.jpg" alt="Images" />
                                            <h3>Cultivating Future Leaders: The Indispensable Role of Leadership Programs</h3>
                                            <div className='row text-center eventsbottomarea2'>
                                                <div className='col-sm-12'>
                                    ...
                                    <div className="col-sm-4">
                                        <div className="choose-card">
                                            ...
                                            <h3>4 Essential Skills Your New Managers <br></br>Need to Know</h3>
                                            <div className='row text-center eventsbottomarea2'>
                                                <div className='col-sm-12'>
                                    ...
                                    <div className="col-sm-4">
                                        <div className="choose-card">
                                            <img src="/kbassets/img/kbnew/blog3.jpg" alt="Images" />
                                            <h3>Self Determination and Self Leadership can Accelerate Your Performance</h3>
                                            <div className='row text-center eventsbottomarea2'>
                                                <div className='col-sm-12'>
                                    ...
                                    <div className="col-sm-4">
                                        <div className="choose-card">
                                            ...
                                            <h3>The Critical Link to a High-Involvement, High-Energy Workplace Begins with a...</h3>
                                            <div className='row text-center eventsbottomarea2'>
                                                <div className='col-sm-12'>
