...
export default function PodCastinner() {
    return (
        <>
        <Head>
        <title>Podcast - How to Design Training for How People Learn with Julie Dirksen</title>
                    ...
                    <div className="col-lg-12">
                        ...
                        <div className="row row-eq-height eventsandworkshopbox">
                            <div className="col-sm-8">
                                ...
                                <iframe allowfullscreen="" height="90" mozallowfullscreen="" msallowfullscreen="" oallowfullscreen="" scrolling="no" src="//html5-player.libsyn.com/embed/episode/id/17297024/height/90/theme/custom/thumbnail/yes/direction/backward/render-playlist/no/custom-color/59a3d4/" webkitallowfullscreen="" width="100%"></iframe>
                                <div>
                                    <p>
                                    ...
                                    <p>
                                    To learn more about Julie Dirksen, go to <a target="_blank" href='https://usablelearning.com/'>www.usablelearning.com.</a>
                                    </p>
                                </div>
                                </div>
                            </div>
