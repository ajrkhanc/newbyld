...
export default function PodCastinner() {
    return (
        <>
        <Head>
        <title>Podcast - Compassionate Accountability with Nate Regier</title>
                        ...
                        <div className="row row-eq-height eventsandworkshopbox">
                            <div className="col-sm-8">
                                ...
                                <div>
                                    ...
                                    <p>
                                    For more information about Nate Regier visit <a target="_blank" href='https://www.next-element.com/resources/books/compassionate-accountability-book/'>www.compassionateaccountabilitybook.com</a>
                                    </p>
                                </div>
                                </div>
                            </div>
