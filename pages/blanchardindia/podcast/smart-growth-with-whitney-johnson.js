...
export default function PodCastinner() {
    return (
        <>
        <Head>
        <title>Podcast - Best of 2022: Smart Growth with Whitney Johnson</title>
                        ...
                        <div className="row row-eq-height eventsandworkshopbox">
                            <div className="col-sm-8">
                                ...
                                <div>
                                    ...
                                    <p>
                                    For more information about Whitney Johnson, visit <a target="_blank" href='https://thedisruptionadvisors.com/'>www.whitneyjohnson.com/newsletter</a> or listen to her Disrupt Yourself podcast.
                                    </p>
                                </div>
                                </div>
                            </div>
