...
export default function PodCastinner() {
    return (
        <>
        <Head>
        <title>Podcast - Motivating Your Team with Catherine Stothart</title>
                        ...
                        <div className="row row-eq-height eventsandworkshopbox">
                            <div className="col-sm-8">
                                ...
                                <div>
                                    ...
                                    <p>
                                    For more information about Catherine Stothart, visit <a target="_blank" href='https://essenwood.co.uk/'>www.essenwood.co.uk</a>
                                    </p>
                                </div>
                                </div>
                            </div>
