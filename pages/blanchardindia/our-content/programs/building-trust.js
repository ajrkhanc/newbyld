                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/kbassets/img/kbnew/BT-great-leadership-begins-with-a-workplace.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className='colortheme2bg'>
                <div className='container-fluid ptt-40 pbb-60 borderedus0'>
                    ...
                    <div className="col-sm-12 ptt-5 pbb-50">
                        ...
                        <div className="col-sm-3">
                            <div className="AProfessional pll-20 prr-20">
                                <img className="" src="/kbassets/img/kbnew/icon/retain-your-talent.svg" alt="Images" />
                        ...
                        <div className="col-sm-3">
                            <div className="AProfessional pll-20 prr-20">
                                <img className="" src="/kbassets/img/kbnew/icon/drive-creativity-and-innovation.svg" alt="Images" />
                        ...
                        <div className="col-sm-3">
                            <div className="AProfessional pll-20 prr-20">
                                <img className="" src="/kbassets/img/kbnew/icon/create-collaboration.svg" alt="Images" />
