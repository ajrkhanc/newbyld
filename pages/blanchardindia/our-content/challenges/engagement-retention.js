                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6 pa0000">
                            <div className="mimg100 pll-90">
                                <img className="" src="/kbassets/img/kbnew/Engaged-employees-are.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='row align-items-center'>
                        <div className='col-sm-6 pa0000'>
                            <div className='prr-90'>
                                <img src="/kbassets/img/kbnew/Leaders-who-create-an-inclusive-culture.jpg" alt="Images" />
                            </div>
                        </div>
                        <div className='col-sm-6'>
                            <div>
                                ...
                                <div className='slxpd30'>
                                    <div className='slbox darkwhiteboxc forwhitec'>
                                        ...
                                        <div className="slboxheight">
                                            ...
                                            <p className='colorblack'>Boost collaboration by better understanding yourself and others</p>
                                            </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/kbassets/img/kbnew/Create-an-engaging-workplace-where.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
