...
export default function ThanYouLP() {
    return (
        <>
            <Head>
                <title>Our Content | Blanchard International</title>
                    ...
                    <div className="row">
                        <div className="col-sm-12 ptt-25 pbb-50">
                            <ul>
                                ...
                                <li><a><span>OUR CONTENT</span></a></li>
                            </ul>
                        </div>

                        <div className="row">
                            <div className="col-sm-6 pa0000">
                                <img className="" src="/kbassets/img/kbnew/Proven-content-that-unlocks.jpg" alt="Images" />
                            </div>
            ...
            <section className="ptt-60 pbb-30 uncommonapproach">
                    ...
                    <div className="row align-items-center">
                        <div className="col-sm-6">
                            ...
                            <ul className="ptt-20">
                                ...
                                <li>Learning materials and digital kbassets are inclusive and accessible to diverse employee groups</li>
                            ...
                            <a href='/blanchardindia/our-content/programs' className='kbbtn kbbtn--orange mtt-20'>View All Leadership Programs</a>
                        </div>
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/kbassets/img/kbnew/An-uncommon-approach.jpg" alt="Images" />
                            </div>
                        </div>

                        <div className="col-sm-12 ptt-40">
                            <hr></hr>
                        </div>
                    </div>
                </div>
            ...
            <section className="ptt-10 pbb-60 uncommonapproach rightimgc">
                <div className="container-fluid">
                    <div className="row align-items-center">
                        <div className="col-sm-6">
                            ...
                            <a href='/blanchardindia/our-content/challenges' className='kbbtn kbbtn--orange mtt-20'>View Challenges</a>
                        </div>
                        <div className="col-sm-6 pa0000">
                            <div className="mimg100 pll-90">
                                <img className="" src="/kbassets/img/kbnew/business-people-working.jpg" alt="Images" />
                            </div>
                        </div>
            ...
            <section className="ptt-10 pbb-60 ExploreCustom">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder prr-90">
                                <img className="" src="/kbassets/img/kbnew/Learning-modalities-that-fit-your-needs.jpg" alt="Images" />
                            </div>
                        </div>
                        ...
                        <div className="col-sm-6">
                            ...
                            <a href='/blanchardindia/our-content/modalities' className='kbbtn kbbtn--orange mtt-20'>View Modalities</a>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className='row align-items-center'>
                        <div className='col-sm-6 pa0000'>
                            <div className='prr-90'>
                                <img src="/kbassets/img/kbnew/people-work.jpg" alt="Images" />
                            </div>
                        </div>
                        <div className='col-sm-6'>
                            <div>
                                ...
                                <div className="col-md-6">
                                    <div className="serventclcbox">
                                        <div className="darkboxservant">
                                            ...
                                            <h3>87%</h3>
                                            <p>
                                                reporting they had applied <br></br>new skills.<sup>1</sup>
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div className='container ptt-90 pbb-60'>
               <div className='row align-items-center'>
               <div className='col-sm-6'>
                     <div className='prr-100 mimg100 imgborder'>
                        <img src="/kbassets/img/kbnew/Invest-in-your-next-generation.jpg" alt="Images" />
                     </div>
                  </div>
                  ...
                  <div className='col-sm-6'>
                     <div>
                        ...
                        <a href='/blanchardindia/get-started' className='kbbtn kbbtn--orange'>Talk to Us</a>
                     </div>
                  </div>
               </div>
            </div>
