...
export default function Ebookpage(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/assets/pdf/slii-why-a-situational-approach-to-leadership-makes-all-the-difference.pdf")
                     }, 3000);
    ...
    return(
        <>
          <Head>
            <title>SLII. Why a Situational Approach to Leadership Makes All the Difference - BYLD Group</title>
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">SLII. Why a Situational Approach to Leadership Makes All the Difference</h4>
                            ...
                            <form id="contact-form" className='clientcornner pbb-20' onSubmit={EbookSubmit}>                                         
                                    <div className="row">
                                        ...
                                        <div className="col-sm-12 mb-12 d-none">
                                            <input type="text" name="formname" value="SLII. Why a Situational Approach to Leadership Makes All the Difference"/>
                                        </div>
                                        <div className="col-sm-12 mb-12 d-none">
