...
export default function Webinars() {
    ...
    const WebinarsForm = async event => {
        ...
        xhttp.open("Post", 'https://byldgroup.in/cruciallifechangingskills/wp-json/contact-form-7/v1/contact-forms/12/feedback');
...
{/*                                             
                        <div class="col-md-4 workshop-col">
                            <div class="row workshop-row">
                                ...
                                <h5 className='eventt'>Virtual Course Preview</h5>
                                <div class="col-md-12 workshop-date green-col">
                                    <h6><i class="fa fa-calendar" aria-hidden="true"></i> 10th April 2024</h6>
                                    <h6><i class="fa fa-clock-o" aria-hidden="true"></i> 3:00 PM - 4:00 PM</h6>
                                    <a href='#registered'><button class="register">REGISTER NOW</button></a>
                                </div>
                            </div>
