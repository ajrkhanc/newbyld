                    ...
                    <div className="row align-items-center">
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder prr-90">
                                <img className="" src="/assets/img/kbnew/Building-resilient-teams-that-deliver.jpg" alt="Images" />
                            </div>
                        </div>
                        <div className='col-sm-6'>
                            <div>
            ...
            <section className="contanerbgc">
                <div className="container colortheme2bg border-top-left-radius-70 ptt-60 pbb-60 ">
                    <div className="row align-items-center">                        
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/assets/img/kbnew/Get-the-tools.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
