        ...
        <>
                    ...
                    <div className="row">
                        ...
                        <div className="row">
                            <div className="col-sm-6 pa0000">
                                <img className="" src="/assets/img/kbnew/Achieve-your-organizations-goals.jpg" alt="Images" />
                            </div>
                ...
                <div className="container">
                    ...
                    <div className="col-sm-6">
                            <div className="mimg100 imgborder prr-90">
                                <img className="" src="/assets/img/kbnew/Section-2.jpg" alt="Images" />
                            </div>
                        </div>
               ...
               <div className='row align-items-center'>
                  <div className='col-sm-6 pa0000'>
                     <div className='prr-90'>
                        <img src="/assets/img/kbnew/Unlocking-human-potential.jpg" alt="Images" />
                     </div>
                  </div>
                  <div className='col-sm-6'>
                     <div>
            ...
            <section className="ptt-60 pbb-60 ExploreCustom">
                <div className="container">
                    ...
                    <div className="col-sm-6">
                            <div className="mimg100 imgborder prr-90">
                                <img className="" src="/assets/img/kbnew/Expert-training-for-and.jpg" alt="Images" />
                            </div>
                        </div>
