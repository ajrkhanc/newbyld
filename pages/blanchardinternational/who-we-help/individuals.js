                    ...
                    <div className="row align-items-center">                       
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/assets/img/kbnew/Take-Charge-of-Your-Career-Growth.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
               ...
               <div className='row align-items-center'>
                  <div className='col-sm-6 pa0000'>
                     <div className='prr-90'>
                        <img src="/assets/img/kbnew/We-put-the-_how_-into.jpg" alt="Images" />
                     </div>
                  </div>
                  <div className='col-sm-6'>
                     <div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 pll-90">
                                <img className="" src="/assets/img/kbnew/Don’t-wait-for-someone-else.jpg" alt="Images" />
                            </div>
                        </div>                
                    </div>
                </div>
