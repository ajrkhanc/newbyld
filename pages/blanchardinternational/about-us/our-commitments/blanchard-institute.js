        ...
        <>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/assets/img/kbnew/Enabling-Every-Child-to.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    ...
                    <div className="col-sm-6">
                            <div className="mimg100 imgborder prr-90">
                                <img className="" src="/assets/img/kbnew/How-The-Blanchard-Institute.jpg" alt="Images" />
                            </div>
                        </div>
                        <div className="col-sm-6">
            ...
            <section className="ptt-60 pbb-60 ExploreCustom">
                <div className="container">
                    ...
                    <div className="col-sm-6">
                            <div className="mimg100 imgborder prr-90">
                                <img className="" src="/assets/img/kbnew/Join-Our-Commitment-to.jpg" alt="Images" />
                            </div>
                        </div>
                        <div className="col-sm-6">
                            ...
                            <a href='/get-started' className='kbbtn kbbtn--orange'>Get Involved Today</a>
                        </div>
                    </div>
                </div>
            </section>
