                    ...
                    <div className="row">
                        ...
                        <div className="row">
                            <div className="col-sm-6 pa0000">
                                <img className="" src="/assets/img/kbnew/Proven-content-that-unlocks.jpg" alt="Images" />
                            </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/assets/img/kbnew/An-uncommon-approach.jpg" alt="Images" />
                            </div>
                        </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6 pa0000">
                            <div className="mimg100 pll-90">
                                <img className="" src="/assets/img/kbnew/business-people-working.jpg" alt="Images" />
                            </div>
                        </div>
                    ...
                    <div className="row align-items-center">
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder prr-90">
                                <img className="" src="/assets/img/kbnew/Learning-modalities-that-fit-your-needs.jpg" alt="Images" />
                            </div>
                        </div>
                    ...
                    <div className='row align-items-center'>
                        <div className='col-sm-6 pa0000'>
                            <div className='prr-90'>
                                <img src="/assets/img/kbnew/people-work.jpg" alt="Images" />
                            </div>
                        </div>
                        <div className='col-sm-6'>
                            <div>
            ...
            <div className='container ptt-90 pbb-60'>
               ...
               <div className='col-sm-6'>
                     <div className='prr-100 mimg100 imgborder'>
                        <img src="/assets/img/kbnew/Invest-in-your-next-generation.jpg" alt="Images" />
                     </div>
                  </div>
