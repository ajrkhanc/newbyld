                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6 pa0000">
                            <div className="mimg100 pll-90">
                                <img className="" src="/assets/img/kbnew/CINC-Creating-a-workplace.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row align-items-center">
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder prr-90">
                                <img className="" src="/assets/img/kbnew/CINC-model-build-a-road-map-to-become.jpg" alt="Images" />
                            </div>
                        </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/assets/img/kbnew/CINC-based-on-a-proven-development-path.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="ptt-90 ExploreCustom colortheme2bg">
                <div className="container mbordee pbb-60">
                    <div className="row align-items-center">
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder prr-90">
                                <img className="" src="/assets/img/kbnew/CINC-it-s-time-to-move-DEI-from-a-business.jpg" alt="Images" />
                            </div>
                        </div>
                    ...
                    <div className='row align-items-center'>
                        ...
                        <div className="col-sm-3">
                            <div className="AProfessional pll-20 prr-20">
                                <img className="" src="/assets/img/kbnew/icon/Expand-workplace-inclusion.svg" alt="Images" />
                        ...
                        <div className="col-sm-3">
                            <div className="AProfessional pll-20 prr-20">
                                <img className="" src="/assets/img/kbnew/icon/Improve-belonging-and-engagement.svg" alt="Images" />
                        ...
                        <div className="col-sm-3">
                            <div className="AProfessional pll-20 prr-20">
                                <img className="" src="/assets/img/kbnew/icon/increase-team-effectiveness.svg" alt="Images" />
                        ...
                        <div className="col-sm-3">
                            <div className="AProfessional pll-20 prr-20">
                                <img className="" src="/assets/img/kbnew/icon/retain-your-talent_1.svg" alt="Images" />
                    ...
                    <div className='row align-items-center'>
                        ...
                        <div className='col-sm-6 pa0000'>
                            <div className='pll-100'>
                                <img src="/assets/img/kbnew/Arizona-DES-spotlight.jpg" alt="Images" />
                            </div>
                        </div>
