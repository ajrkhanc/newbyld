                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6 pa0000">
                            <div className="mimg100 pll-90">
                                <img className="" src="/assets/img/kbnew/SLII-Video-img.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row align-items-center">
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder prr-90">
                                <img className="" src="/assets/img/kbnew/SLII-model.jpg" alt="Images" />
                            </div>
                        </div>
                                    ...
                                    <TabPanel className="tabdetails colortheme2bg">
                                        <div className="">
                                            <div className="tabinner">
                                                ...
                                                <p>
                                                    Our digital assets include tools, interactions, and micro-learning movies offering browseable information for just-in-time assistance.
                                                </p>
                                                <p>
                                                    Through digital assets, leaders can access adaptable micro-activities such as films, interactions, and worksheets to provide ongoing learning, performance support, reinforcement, and personalized learning journeys.
                                                </p>
                                            </div>
                                        </div>
                                    </TabPanel>
            ...
            <section className='colortheme2bg'>
                <div className='container-fluid ptt-5 pbb-60 borderedus0'>
                    ...
                    <div className="col-sm-12 ptt-5 pbb-50">
                        ...
                        <div className="col-sm-3">
                            <div className="AProfessional pll-20 prr-20">
                                <img className="" src="/assets/img/kbnew/icon/Common-Language.svg" alt="Images" />
                        ...
                        <div className="col-sm-3">
                            <div className="AProfessional pll-20 prr-20">
                                <img className="" src="/assets/img/kbnew/icon/Retention.svg" alt="Images" />
                        ...
                        <div className="col-sm-3">
                            <div className="AProfessional pll-20 prr-20">
                                <img className="" src="/assets/img/kbnew/icon/Creativity.svg" alt="Images" />
