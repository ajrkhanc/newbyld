                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/assets/img/kbnew/TL-team-leadership-training-to-power-high-performance.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row align-items-center">
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder prr-90">
                                <img className="" src="/assets/img/kbnew/TL-model-invest-in-team-leader.jpg" alt="Images" />
                            </div>
                        </div>
            ...
            <section className='colortheme2bg'>
                <div className='container-fluid ptt-40 pbb-60 borderedus0'>
                    ...
                    <div className="col-sm-12 ptt-5 pbb-50">
                        ...
                        <div className="col-sm-3">
                            <div className="AProfessional pll-20 prr-20">
                                <img className="" src="/assets/img/kbnew/icon/achieve-superior-results.svg" alt="Images" />
                        ...
                        <div className="col-sm-3">
                            <div className="AProfessional pll-20 prr-20">
                                <img className="" src="/assets/img/kbnew/icon/Increase-innovation.svg" alt="Images" />
                        ...
                        <div className="col-sm-3">
                            <div className="AProfessional pll-20 prr-20">
                                <img className="" src="/assets/img/kbnew/icon/make-high-performance-the-norm.svg" alt="Images" />
