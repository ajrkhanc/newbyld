                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6 pa0000">
                            <div className="mimg100 pll-90">
                                <img className="" src="/assets/img/kbnew/Leadership-isn’t-limited-to.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='row align-items-center'>
                        <div className='col-sm-6 pa0000'>
                            <div className='prr-90'>
                                <img src="/assets/img/kbnew/Great-leaders-learn-to-adapt.jpg" alt="Images" />
                            </div>
                        </div>
                        <div className='col-sm-6'>
                            <div>
                                ...
                                <div className='slxpd30'>
                                    <div className='slbox darkblueboxc forwhitec'>
                                        ...
                                        <div className="slboxheight">
                                            ...
                                            <a href='/our-content/programs/servant-leadership-essentials' className='kbbtn kbbtn--orange'>Learn More</a></div>
                                    </div>
                                </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/assets/img/kbnew/Expand-your-organization’s-leadership-capability.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
