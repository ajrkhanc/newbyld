                    ...
                    <div className="row">
                        ...
                        <div className="row">
                            <div className="col-sm-6 pa0000">
                                <img className="" src="/assets/img/kbnew/diverse-people-working-office.jpg" alt="Images" />
                            </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder prr-90">
                                <img className="" src="/assets/img/kbnew/Turning-New-Hires-into-Top.jpg" alt="Images" />
                            </div>
                        </div>
                    ...
                    <div className='row align-items-center'>
                        ...
                        <div className='col-sm-6 pa0000'>
                            <div className='mimg100 imgborder pll-90'>
                                <img src="/assets/img/kbnew/Succeeding-in-a-Hybrid-Work-Environment.jpg" alt="Images" />
                            </div>
                        </div>
                     ...
                     <Slider {...settings2}>
                           ...
                           <div className='FeaturedBooksc'>                            
                              <div className='FeaturedBookscinner'>
                                <div className="sl2imgbox">
                                    <img src="/assets/img/kbnew/The-New-One-Minute-Manager-250px.png"/>
                                </div>                              
                        ...
                        <div className='cfv'>
                           <div className='FeaturedBooksc'>                            
                              <div className='FeaturedBookscinner'>
                                <div className="sl2imgbox">
                                    <img src="/assets/img/kbnew/Leading-at-a-Higher-Level-250px.png"/>
                                </div>                              
                        ...
                        <div className='cfv'>
                           <div className='FeaturedBooksc'>                            
                              <div className='FeaturedBookscinner'>
                                <div className="sl2imgbox">
                                    <img src="/assets/img/kbnew/Leadership-and-the-One-Minute-Manager-250px.png"/>
                                </div>                              
                        ...
                        <div className='cfv'>
                           <div className='FeaturedBooksc'>                            
                              <div className='FeaturedBookscinner'>
                                <div className="sl2imgbox">
                                    <img src="/assets/img/kbnew/TrustWorks.png"/>
                                </div>                              
                                 <h3>TrustWorks!</h3>
                        ...
                        <div className='cfv'>
                           <div className='FeaturedBooksc'>                            
                              <div className='FeaturedBookscinner'>
                                <div className="sl2imgbox">
                                    <img src="/assets/img/kbnew/Self-Leadership-and-the-One-Minute-Manager.png"/>
                                </div>                              
