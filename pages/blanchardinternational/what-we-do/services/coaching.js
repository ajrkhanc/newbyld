                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="mimg100 imgborder prr-90">
                                <img src="/assets/img/kbnew/Transform-Your-People-With-Coaching.jpg" alt="Images" />
                            </div>
                        </div>
                        <div className='col-sm-6'>
                            <div>
            ...
            <div className='container-fluid ptt-90 pbb-60 borderedus0'>
               ...
               <div className="col-sm-1"></div>                
                  ...
                  <div className="col-sm-3">
                    ...
                    <img className="" src="/assets/img/kbnew/icon/Speedy-Skill-Adoption.svg" alt="Images" />
                  ...
                  <div className="col-sm-3">
                    <div className="AProfessional pll-20 prr-20">
                    <img className="" src="/assets/img/kbnew/icon/Build-Leadership-Bench.svg" alt="Images" />
                  ...
                  <div className="col-sm-3">
                    <div className="AProfessional pll-20 prr-20">
                    <img className="" src="/assets/img/kbnew/icon/Improve-Productivity_1.svg" alt="Images" />
                  ...
                  <div className="col-sm-3">
                    <div className="AProfessional pll-20 prr-20">
                    <img className="" src="/assets/img/kbnew/icon/Increase-Learning-Retention.svg" alt="Images" />
         ...
         <section className="ptt-60 pbb-60">
                <div className="container">
                    <div className="row align-items-center">
                        <div className='col-sm-6'>
                        <div className="mimg100 imgborder prr-90">
                                <img src="/assets/img/kbnew/Coaching-for-Executives-and-Senior-Leaders.jpg" alt="Images" />
                            </div>
                        </div>
                        <div className='col-sm-6'>
                            <div>
                ...
                <div className="container">
                    <div className="row align-items-center">                        
                        ...
                        <div className="mimg100 imgborder pll-90">
                                <img src="/assets/img/kbnew/Team-Coaching.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="ptt-60 pbb-60">
                <div className="container">
                    ...
                    <div className='col-sm-6'>
                        <div className="mimg100 imgborder prr-90">
                                <img src="/assets/img/kbnew/Coaching-to-Integrate-Learning-for-Individuals.jpg" alt="Images" />
                            </div>
                        </div>
