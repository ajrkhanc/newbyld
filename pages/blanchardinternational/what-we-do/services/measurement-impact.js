               ...
               <div className="row align-items-center">
                  ...
                  <div className="col-sm-6">
                     <div className="mimg100 imgborder pll-90">
                        <img className="" src="/assets/img/kbnew/Was-It-Successful.jpg" alt="Images" />
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div className="container pbb-50">
               <div className='row'>
                  ...
                  <div className='col-sm-4'>
                     <div className='reinner inncc'>
                        <a className="minihc" href='#'>
                           <img src="/assets/img/kbnew/icon/Extensive-Experience.svg" alt="Images" />
                  ...
                  <div className='col-sm-4'>
                     <div className='reinner inncc'>
                        <a className="minihc" href='#'>
                           <img src="/assets/img/kbnew/icon/Objective-Analysis.svg" alt="Images" />
                  ...
                  <div className='col-sm-4'>
                     <div className='reinner inncc'>
                        <a className="minihc" href='#'>
                           <img src="/assets/img/kbnew/icon/Seasoned-Experts.svg" alt="Images" />
               ...
               <div className='row align-items-center'>
                  <div className='col-sm-6'>
                     <div className="mimg100 imgborder prr-90">
                        <img src="/assets/img/kbnew/evaluations-and-surveys.jpg" alt="Images" />
                     </div>
                  </div>
                  <div className='col-sm-6'>
                     <div>
         ...
         <section className='Innovativelearning'>
            <div className='container-fluid ptt-90 pbb-60 borderedus0'>
               <div className='row align-items-center'>
                  ...
                  <div className='col-sm-6'>
                     <div className="mimg100 imgborder pll-90">
                        <img src="/assets/img/kbnew/Lets-discuss-your-assessment-needs.jpg" alt="Images" />
                     </div>
                  </div>
               </div>
            </div>
