               ...
               <div className="row align-items-center">
                  ...
                  <div className="col-sm-6">
                     <div className="mimg100 imgborder pll-90">
                        <img className="" src="/assets/img/kbnew/Every-Experience-Matters.jpg" alt="Images" />
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div className='row align-items-center'>
                  <div className='col-sm-6'>
                     <div className="mimg100 imgborder prr-90">
                        <img src="/assets/img/kbnew/Great-leadership-starts-with-you.jpg" alt="Images" />
                     </div>
                  </div>
                  <div className='col-sm-6'>
                     <div>
         ...
         <section className='Innovativelearning'>
            <div className='container-fluid ptt-90 pbb-60 borderedus0'>
               <div className='row align-items-center'>
                  ...
                  <div className='col-sm-6'>
                     <div className="mimg100 imgborder pll-90">
                        <img src="/assets/img/kbnew/Situational-leadership-that-inspires.jpg" alt="Images" />
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div className='container-fluid ptt-90 pbb-60 borderedus0 contanerbgc'>
               <div className='row align-items-center'>
                  ...
                  <div className='prr-90'>
                        <img src="/assets/img/kbnew/Define-a-leadership-vision.jpg" alt="Images" />
                     </div>
                  </div>
                  <div className='col-sm-6'>
                     <div>
