                    ...
                    <div className="row">
                        ...
                        <div className="row">
                            <div className="col-sm-6 pa0000">
                                <img className="" src="/assets/img/kbnew/Dynamic-Human-Powered-Learning.jpg" alt="Images" />
                            </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/assets/img/kbnew/Giving-leaders-everywhere.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 pll-90">
                                <img className="" src="/assets/img/kbnew/Services-that-Support.jpg" alt="Images" />
                            </div>
                        </div>
                ...
                <div className="container">
                    ...
                    <div className="col-sm-6">
                            <div className="mimg100 imgborder prr-90">
                                <img className="" src="/assets/img/kbnew/Custom-Solutions-Tailored.jpg" alt="Images" />
                            </div>
                        </div>
            ...
            <section className="ptt-60 pbb-60 ExploreCustom Unleashleadership">
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/assets/img/kbnew/Unleash-your-leadership.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
