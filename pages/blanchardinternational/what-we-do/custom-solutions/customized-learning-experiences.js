                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/assets/img/kbnew/Tailor-content-and-delivery.jpg" alt="Images" />
                            </div>
                        </div>                       
                    </div>
                </div>
         ...
         <section className="Supportinglearning ptt-80 pbb-60">
                <div className="container-fluid">
                    ...
                    <div className="col-sm-6">
                        <div className="mimg100 imgborder prr-90">
                                <img className="" src="/assets/img/kbnew/Our-Solutions-Architecture-Center-of-Excellence.jpg" alt="Images" />
                            </div>
                        </div>
            ...
            <section className="ptt-60 pbb-60 ExploreCustom colortheme2bg">
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-6">
                            <div className="mimg100 imgborder pll-90">
                                <img className="" src="/assets/img/kbnew/Custom-Design-Guiding-Principles.jpg" alt="Images" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="Supportinglearning ptt-80 pbb-60">
                <div className="container-fluid">
                    ...
                    <div className="col-sm-6">
                        <div className="mimg100 imgborder prr-90">
                                <img className="" src="/assets/img/kbnew/Let’s-Discuss-Your-Online-Leadership-Development-Needs.jpg" alt="Images" />
                            </div>
                        </div>
                        <div className="col-sm-6 pll-30">
