   ...
   return (
      <>
         <Head>
            ...
            <meta name="description" content="Learn how Blanchard can help you create leadership development learning journeys that integrate with your existing LMS or incorporate your existing content assets." />
               ...
               <div className="row align-items-center">
                  ...
                  <div className="col-sm-6">
                     <div className="mimg100 imgborder pll-90">
                        <img className="" src="/assets/img/kbnew/Create-a-cohesive-learning-experience.jpg" alt="Images" />
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div className='container-fluid ptt-90 pbb-60 borderedus0 contanerbgc'>
               <div className='row align-items-center'>
                  ...
                  <div className="mimg100 imgborder prr-90">
                        <img src="/assets/img/kbnew/How-content-integration-drives-experience.jpg" alt="Images" />
                     </div>
                  </div>
                  <div className='col-sm-6'>
                     <div>
         ...
         <section className="ptt-60 pbb-60 ExploreCustom contanerbgc">
            <div className="container">
               <div className="row align-items-center">
                  ...
                  <div className="col-sm-6">
                     <div className="mimg100 imgborder pll-90">
                        <img className="" src="/assets/img/kbnew/Let’s-discuss-your-custom-learning-experiences-needs.jpg" alt="Images" />
                     </div>
                  </div>
               </div>
            </div>
