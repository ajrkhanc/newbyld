...
export async function getServerSideProps(context) {    
    ...
    const cat = await fetch('https://byldblogs-4eef.onrender.com/api/categories')
    const cats = await cat.json()


    const caturl = context.params.blogCat;
    const res = await fetch(`https://byldblogs-4eef.onrender.com/api/posts/category/${caturl}`)
