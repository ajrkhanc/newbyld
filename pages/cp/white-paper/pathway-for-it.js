...
export default function Ebookpage(){
    ...
    return(
        <>
          <Head>
            <title>Pathway For IT Professionals In The Wake of Large Scale Layoffs</title>
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">Pathway For IT Professionals In The Wake of Large Scale Layoffs</h4>
